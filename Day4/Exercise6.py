...
# transactions.log writes: "[ROLLBACK] Batch aborted: OverdraftError - Insufficient funds. Account ACC02 has bal
"""
            ...
            if transaction_type == "withdraw":
                ...
                if accounts[acc] < amt:
                    raise OverdraftError(
                        f"Insufficient funds. Account {acc} "
                        f"has balance {accounts[acc]}, requested {amt}."
                    )
